...
public class C_Cast {
	...
	//자료형변환 : 작은바이트의 자료형이 큰바이트의 자료형으로 형변환 되는 경우
	public void autoCasting() {
		...
		//	 float형이 실수이기때문에 long형보다 표현가능한 범위의수가 더 커서 자동형변환이 이루어진다.
		...
		//4. 특이케이스 char(2byte) <-> int(4byte) : 양방향 형변환이 가능.
	...
	public void forceCasting() {
		...
		// 해결방법 1. 연산결과를 int형으로 맞춰서 강제형 변환.
		int iSum = (int)(iNum + dNum); // 15
		
		// 해결방법 2. 덧셈 연산전에 dNum변수를 미리 int형으로 강제형 변환.
