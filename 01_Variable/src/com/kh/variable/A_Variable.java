...
public class A_Variable {
	...
	public void printVariable() {
		...
		System.out.println("김진기 : "+ (11000 * 4 * 5) +"원 입니다.");
		...
		System.out.println("김진기 : "+(pay * time * day)+"원 입니다.");
	...
	public void declareVariable() {
		...
		short sNum; //2byte
		int iNum; 	//4byte(-21djr..~ 21억...) => 정수형중에 가장 대표적인 자료형(기본형)
		long lNum; 	//8byte
		
		//2_2. 실수형
		float fNum;	//4byte => 소수점 아래 7자리까지 표현가능.
		double dNum;//8byte => 수수점 아래 15자리까지 표현이가능.
		...
		ch = 'A'; 	// 반드시 ''(작은따옴표)안에 넣어줘야함. (한글자만 가능)
	...
	public void constantVariable() {
		...
		//상수는 값을 모두 대문자로 표기해야하며 final 을 추가해야함 final 이후 값 변경 시 변경되지않음
	}
