...
public class A_Array {
	...
	public void method1() {
		...
		// [I@1888ff2c 여기서 @기준으로 우측은 참조하고있는 heap 영역에 주소값
		// [ : 배열임을 나타냄
		// I : int 자료형을 의미함.
	...
	public void method3() {
		 ...
		 * -> heap라는 영역에는 절대로 빈공간이 존재할수 없기 때문.
	...
	public void method7() {
		...
		// arr1 -> arr1의 heap영역에 "주소값"
		// arr2 -> arr2의 heap영역에 "주소값"
	...
	public void method11() {
		// 1. 사용자에게 배열의길이 입력받은후, 해당 크기만큼 점수배열 생성
		Scanner sc = new Scanner(System.in);
		System.out.print("배열의 길이 입력 : ");
		int num = sc.nextInt();
		int[] arr = new int[num];
		
		// 2. 반복문 확용해서 0번 인덱스부터 마지막 인덱스까지 순차적으로 접근하면서 값 대입
		//   -> 랜덤값(1~100)
		for(int i = 0; i < arr.length; i++) { // 0, 1, 2, 3,... (num-1)
			arr[i] = (int)(Math.random() * 100 + 1);
		}
		
		// 3. 반복문 활용해서 0번 인덱스부터 ~ 마지막인덱스까지 배열에 담긴 값 출력과 동시에,
...
//		//1. 반복문을 활용해서 heights 배열의 0번 인덱스부터 마지막인덱스까지 반복을
...
//			System.out.println("3명의 키의 총 합계 : %.1f", sum);
//			System.out.println(", 3명의 키의 평균 : %.1ㄹf", sum/3);
