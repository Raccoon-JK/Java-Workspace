...
public class ExceptionRun {
	...
	/*
	 *  에러(오류) 종류
	 * - 시스템 에러 : 컴퓨터의오작동으로 인해 발생하는 에러 => 소스코드로 해결 안됨(심각한 에러)
	 ...
	 * - 논리 에러 : 소스코드상으로 문제 없고, 실행했을 때도 에러가 발생하지 않지만, 의도한대로 결과가 나오지않는 경우
	 * 
	 ...
	 * 
	 * 예외처리를 해야하는 이유 : 예외 발생 시 프로그램이 비 정상적으로 종료되는것을 막기 위함.
	 * 
	 * 예외처리방법
	 * 1. try ~ catch (직접처리)
	 * 2. throws 이용 (떠넘기기)
