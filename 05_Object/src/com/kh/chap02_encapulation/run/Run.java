...
public class Run {
	/*
	 * 7. 캡슐화 과정을 통해 완변한 클래스의 틀을 갖추게 하기.
	 *  * 캡슐화란 ? 추상화를 통해 정의된 속성들과 기능들을 하나로 묶어 관ㄹ리하는 기법중 하나로
...
//		hong.name = "홍길동"; // the filed Student.name is not vissible
//		hong.age = 20;
//		hong.height = 166.6;)
//		
		/*
		 * 위와 같이 대입할 경우 직접 접근이 불가능해짐
		 * 그러면 직접적인 접근을 막은 경우 간접적으로나마 접근할수 있는 방법?
		 * setter / getter
		 */
		//setter메서드 호출
		hong.setName("홍길동");
