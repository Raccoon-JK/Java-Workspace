...
public class Student {
	...
	//이름값을 기록 및 수정할수 있는 기능의 메소드(name필드에 값을 넣기 위한 용도)
	...
	public void setName(String name) {
		...
		// 왜? 필드명과 매개변수명이 동일한경우 {}영역 내에서는 해당영역에서 만들어진 변수가 좀더 우선순위가 높기 때문.
	...
	// 키값을 기록 및 수정할수 있는 기능의 메소드 (height필드에 값을 대입하기 위한 용도)
