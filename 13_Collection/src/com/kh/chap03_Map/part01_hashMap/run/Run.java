...
public class Run {
	...
	public static void main(String[] args) {
		...
		/*
		 * 계층구조를 보면 List나 Set 계열은 Collection을 구현한 클래스 => 데이터를 추출할떄 add메소드
		 * 단, Map은 아니다 => 데이터를 추가할 떄 put메소드 사용(key+value 세트로 추가)
		 * 
		 */
		...
		//1. 저장순서 유지 x
		//2. value값이 동일하다고해도, key값이 중복되지않기 때문에 잘 저장됨.
		...
		// 4. replace(K key m V value) => 컬렉션에서 해당 key값을 찾아내서 새로 전달된 value로 변경해주는 메소드
		...
		// List와 Map은 다른 계열이기 떄문에 ArrayList에 담은 후 출력 불가.
