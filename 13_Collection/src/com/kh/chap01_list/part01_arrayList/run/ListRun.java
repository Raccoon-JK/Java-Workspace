...
public class ListRun {
	...
	public static void main(String[] args) {
		 ...
		 * == 컬렉션
		 * => 다량의 데이터들을 관리하고자 할 떄 배열 가지고 충분히 사용했었음, 단 배열의 단점들을 보완한 것이 컬렉션.
		 * 
		 * 배열과 컬렉션의 차이점
		 * - 배열의 단점
		 ...
		 * 해당 컬렉션에 다양한 타입의 데이터값들이 담길수 있음.(Defualt E == Object)
		 * 
		...
		// 중간에 값 추가 시 알아서 기존의 값들을 뒤로 떙겨주는 작업이 내부적으로 진행됨.
		...
		// 7. subList(int indew1, int index2) : 해당 리스트로부터 index1에서 index2까지의 데이터 값들을
