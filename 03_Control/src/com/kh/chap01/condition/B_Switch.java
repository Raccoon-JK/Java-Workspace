...
public class B_Switch {
	 ...
	 * 			 break;
	 * ...
	 * default : 실행할 코드 // if~ else문에서 else와같은 역활을 함.
	 *  				  // 위의 값1, 값2, 값n... 앞으로 동등비교를 할 대상과 하나도일치하지 않다면
	 *  				  // default내의 실행할코드가 실행된다. 	
	 * }
	 * 
	 * swith문 자주 사용되진 않지만, 사용하는 경우에는 정말 정밀하게 동일한 연산결과가 수행되어야 하는경우
	 * ex) 키보드입력, 마우스입력등.
	 * 
	 */
...
//		}
	...
	public void method2() {
		...
		System.out.println("구매할 과일을 입력하세요(사과, 바나나, 북숭아) : ");
...
//			System.out.println("복숭아의 가격은 5000원 입니다.");
//		} else {
...
//		}
	...
	public void method4() {
		...
		default: System.out.println("반드시 1~12월까지 입력해야합니다.");
		}
